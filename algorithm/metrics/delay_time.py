...
def calc_time_diff(objects: list[Objects]) -> None:
    avg_sum = 0
    car_leaves = deque()
    ...
    for object_frame in objects:
        ...
        if sum_cars:
            avg_delay_time_mins = max(0, calc_avg_delay_time(curr_dt, avg_sum, car_leaves))
